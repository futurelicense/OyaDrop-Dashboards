    ...
    return (
      <div className="flex flex-col h-full bg-[#0A0E1A]">
        ...
        <div className="flex items-center gap-3 p-4 bg-[#131B2E] border-b border-white/10">
          ...
          <motion.button
            className="p-2 bg-cyan-500/20 border border-cyan-500/30 rounded-xl"
            whileTap={{
              scale: 0.95
            }}>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          ...
          <motion.div
            ...
            transition={{
              ...
              <div
              className={`max-w-[75%] rounded-2xl px-4 py-3 ${msg.sender === 'store' ? 'bg-gradient-to-r from-cyan-500 to-teal-500 text-white rounded-br-sm' : 'bg-[#131B2E] text-white rounded-bl-sm'}`}>
              
                <p className="text-sm">{msg.text}</p>
                <p
                className={`text-xs mt-1 ${msg.sender === 'store' ? 'text-white/70' : 'text-gray-400'}`}>
        ...
        <div className="px-4 py-2 border-t border-white/10 bg-[#131B2E]">
          <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
            ...
            <motion.button
              key={reply}
              className="flex-shrink-0 px-3 py-2 bg-[#0A0E1A] border border-white/10 rounded-xl text-xs font-semibold text-white"
              whileTap={{
                scale: 0.95
              }}>
