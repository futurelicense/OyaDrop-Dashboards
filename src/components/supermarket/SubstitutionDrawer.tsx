...
},
{
  ...
  stock: 40,
  image:
  'https://images.unsplash.com/photo-1561136594-7f68413baa99?w=200&h=200&fit=crop'
}];
      ...
      <>
          ...
          transition={{
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4 space-y-3">
              {mockSubstitutes.map((substitute, index) =>
            <motion.button
              key={substitute.id}
              className="w-full bg-[#0A0E1A] rounded-2xl p-4 border border-white/10 text-left"
              initial={{
                opacity: 0,
                y: 20
              }}
            ...
            <div className="px-6 py-4 border-t border-white/10 bg-[#0A0E1A]">
              <motion.button
              className="w-full bg-red-500/20 border border-red-500/30 text-red-400 font-bold py-3 rounded-xl"
              whileTap={{
                scale: 0.98
              }}
              onClick={onClose}>
