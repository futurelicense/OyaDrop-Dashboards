        ...
        {achievements.map((achievement, index) => {
          ...
          return (
            <motion.div
              ...
              className={`relative rounded-xl p-4 border ${achievement.unlocked ? 'bg-gradient-to-br from-[#1a2a2f] to-[#1f2f35] border-white/20' : 'bg-[#0a1a1f]/50 border-white/5'} overflow-hidden`}
              initial={{
                opacity: 0,
                scale: 0.8
              }}
              ...
              <div className="relative flex flex-col items-center text-center">
                <motion.div
                  className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 ${achievement.unlocked ? 'shadow-lg' : 'opacity-30'}`}
                  style={{
                ...
                {achievement.unlocked &&
                <motion.div
                  className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-[#00ff88] flex items-center justify-center shadow-[0_0_8px_rgba(0,255,136,0.6)]"
                  initial={{
                    scale: 0
                  }}
                  animate={{
