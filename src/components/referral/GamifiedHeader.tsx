...
export function GamifiedHeader({ onMenuClick }: GamifiedHeaderProps) {
  ...
  return (
    <motion.header
      className="sticky top-0 z-50 bg-gradient-to-b from-[#0a1a1f] via-[#0f2027] to-transparent backdrop-blur-xl border-b border-[#00ffcc]/20"
      initial={{
        y: -20,
        opacity: 0
      }}
      ...
      <div className="px-5 pt-4 pb-3">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              className="w-9 h-9 rounded-full bg-gradient-to-br from-[#00ffcc] to-[#00d9ff] p-0.5 shadow-[0_0_12px_rgba(0,255,204,0.4)]"
              whileTap={{
                scale: 0.95
              }}>
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <motion.div
            className="flex items-center gap-2 bg-gradient-to-br from-[#ff6b00] to-[#ff0000] px-3 py-2 rounded-full shadow-[0_0_16px_rgba(255,107,0,0.4)]"
            initial={{
              x: 20,
              opacity: 0
            }}
