  ...
  return (
    <div className="px-5 py-6 pb-8">
      ...
      <div className="flex gap-2 mb-6">
        ...
        <motion.button
          key={tab}
          className={`flex-1 py-2.5 rounded-full text-sm font-semibold transition-all ${activeTab === tab ? 'bg-gradient-to-r from-[#00ffcc] to-[#00d9ff] text-[#0a1a1f] shadow-[0_0_16px_rgba(0,255,204,0.4)]' : 'bg-[#1a2a2f] text-gray-400 border border-white/10'}`}
      ...
      <div className="space-y-2">
        ...
        <motion.div
          key={player.rank}
          className={`relative rounded-xl p-4 border ${player.isCurrentUser ? 'bg-gradient-to-br from-[#00ffcc]/20 to-[#00d9ff]/10 border-[#00ffcc]/40 shadow-[0_0_16px_rgba(0,255,204,0.2)]' : 'bg-gradient-to-br from-[#1a2a2f] to-[#1f2f35] border-white/10'} overflow-hidden`}
          initial={{
            opacity: 0,
            x: -20
          }}
          ...
          <div
            ...
            <motion.div
              className="bg-gradient-to-r from-[#00ffcc] to-[#00d9ff] px-3 py-1 rounded-full"
              initial={{
                scale: 0
              }}
              animate={{
