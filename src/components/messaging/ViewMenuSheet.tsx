...
export function ViewMenuSheet({
  ...
  const totalPrice = mockMenu.reduce(
    ...
    <AnimatePresence>
      ...
      <>
          ...
          transition={{
                ...
                transition={{
                  delay: index * 0.1
                    ...
                    <div className="px-4 pb-4">
                      {cart[item.id] ?
                  <div className="flex items-center justify-between bg-cyan-500/20 border border-cyan-500/30 rounded-xl p-2">
                          <motion.button
                  ...
                  <motion.button
                    className="w-full bg-gradient-to-r from-cyan-500 to-teal-500 text-white font-semibold py-2.5 rounded-xl flex items-center justify-center gap-2"
                    whileTap={{
                      scale: 0.98
                    }}
                    onClick={() => addToCart(item.id)}>
            ...
            {totalItems > 0 &&
          <motion.div
            className="px-6 py-4 border-t border-white/10 bg-[#0A0E1A]"
            initial={{
              y: 100
            }}
            animate={{
              y: 0
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <motion.button
                className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white font-bold px-8 py-3 rounded-xl shadow-lg flex items-center gap-2"
                whileTap={{
                  scale: 0.98
                }}>
