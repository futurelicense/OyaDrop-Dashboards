  ...
  return (
    <div className="flex flex-col h-full bg-[#0A0E1A]">
      ...
      <div className="p-4 border-b border-white/10">
        <motion.button
          className="w-full flex items-center gap-3 p-4 bg-gradient-to-br from-cyan-500/20 to-teal-500/20 border-2 border-dashed border-cyan-500/50 rounded-2xl"
          whileTap={{
            scale: 0.98
          }}
            ...
            onClick={() => onViewUpdate(update)}>
              ...
              <img
                ...
                <div className="flex items-center gap-4 pt-3 border-t border-white/10">
                  ...
                  <motion.button
                  className={`flex items-center gap-1.5 ${update.hasLiked ? 'text-red-400' : 'text-gray-400'}`}
                  onClick={(e) => {
                    e.stopPropagation();
                  ...
                  <motion.button
                  className="flex items-center gap-1.5 text-gray-400 ml-auto"
                  onClick={(e) => {
                    e.stopPropagation();
                  }}
                  whileTap={{
