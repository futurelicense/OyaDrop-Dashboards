...
export function InChatActionButtons({
  ...
  return (
    <div className="px-4 py-3 border-t border-white/10 bg-[#131B2E]">
      ...
      <div className="grid grid-cols-2 gap-2">
        {actions.map((action, index) => {
          ...
          return (
            <motion.button
              key={action.id}
              className="flex items-center gap-2 p-3 bg-[#0A0E1A] rounded-xl border border-white/10 hover:border-white/20 transition-colors"
              initial={{
                opacity: 0,
                y: 10
              }}
