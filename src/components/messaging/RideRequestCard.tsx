...
export function RideRequestCard({
  ...
  return (
    <motion.div
      className="max-w-[85%] bg-gradient-to-br from-[#131B2E] to-[#0F1520] rounded-2xl rounded-br-sm p-4 border border-cyan-500/30"
      initial={{
        opacity: 0,
        scale: 0.9
      }}
      ...
      <div className="flex gap-2">
        <motion.button
          className="flex-1 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white font-semibold text-sm"
          whileTap={{
            scale: 0.98
          }}>
        ...
        <motion.button
          className="flex-1 py-2.5 bg-gradient-to-r from-cyan-500 to-teal-500 rounded-xl text-white font-semibold text-sm shadow-lg"
          whileTap={{
            scale: 0.98
          }}>
