  ...
  return (
    <AnimatePresence>
      ...
      <>
          ...
          {/* Full Screen View */}
          <motion.div
          className="fixed inset-0 z-[90] flex flex-col bg-[#0A0E1A]"
          initial={{
            opacity: 0
          }}
          animate={{
          ...
          exit={{
            ...
            <div className="p-4 border-t border-white/10 bg-[#131B2E]">
              <div className="flex gap-2 mb-3">
                <motion.button
                className={`flex-1 py-3 rounded-xl font-semibold flex items-center justify-center gap-2 ${hasLiked ? 'bg-red-500/20 border-2 border-red-500 text-red-400' : 'bg-[#0A0E1A] border-2 border-white/10 text-white'}`}
                whileTap={{
                  scale: 0.98
                }}
                onClick={toggleLike}>
                ...
                <motion.button
                className="flex-1 py-3 bg-[#0A0E1A] border-2 border-white/10 rounded-xl text-white font-semibold flex items-center justify-center gap-2"
                whileTap={{
                  scale: 0.98
                }}>
