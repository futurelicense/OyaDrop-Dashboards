            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <motion.button
                  className={`p-4 rounded-xl border-2 transition-all ${scheduledTime === 'now' ? 'bg-cyan-500/20 border-cyan-500' : 'bg-[#0A0E1A] border-white/10'}`}
                  ...
                  <motion.button
                  className={`p-4 rounded-xl border-2 transition-all ${scheduledTime === 'later' ? 'bg-cyan-500/20 border-cyan-500' : 'bg-[#0A0E1A] border-white/10'}`}
