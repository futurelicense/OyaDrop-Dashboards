      ...
      <div className="flex flex-col h-screen bg-[#0A0E1A]">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          ...
          <motion.div
            ...
            <div
              ...
              {msg.type === 'group-order' && msg.data &&
            <GroupOrderCard {...msg.data} />
            }

              {msg.type === 'ride-request' && msg.data &&
            <RideRequestCard {...msg.data} />
            }
            </motion.div>
          )}
        ...
        <div className="p-4 bg-[#131B2E] border-t border-white/10">
          <div className="flex items-center gap-2">
            ...
            {message ?
            <motion.button
              className="p-3 bg-gradient-to-r from-cyan-500 to-teal-500 rounded-xl shadow-lg shadow-cyan-500/30"
              whileTap={{
                scale: 0.95
              }}
              initial={{
            ...
            <motion.button
              className="p-3 bg-[#0A0E1A] rounded-xl border border-white/10"
              whileTap={{
                scale: 0.95
              }}>
