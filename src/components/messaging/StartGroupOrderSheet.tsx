          ...
          transition={{
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
              ...
              <div>
                ...
                <input
                type="text"
                placeholder="e.g., Office Lunch, Team Dinner"
                value={groupName}
              ...
              <div>
                ...
                <motion.button
                  key={mins}
                  className={`p-3 rounded-xl border-2 transition-all ${deadline === mins ? 'bg-purple-500/20 border-purple-500' : 'bg-[#0A0E1A] border-white/10'}`}
                  onClick={() => setDeadline(mins)}
                  whileTap={{
                    scale: 0.98
                  }}>
              ...
              <div>
                ...
                <motion.button
                  key={contact.id}
                  className={`w-full flex items-center gap-3 p-3 rounded-xl border-2 transition-all ${selectedContacts.includes(contact.id) ? 'bg-purple-500/20 border-purple-500' : 'bg-[#0A0E1A] border-white/10'}`}
            ...
            <div className="px-6 py-4 border-t border-white/10 bg-[#0A0E1A]">
              <motion.button
              className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-4 rounded-xl shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              whileTap={{
