...
export function FastFoodCard({
  ...
  return (
    <motion.div
      className="relative bg-gradient-to-br from-[#131B2E] to-[#0F1520] rounded-2xl overflow-hidden border border-white/10"
      initial={{
        opacity: 0,
        y: 20
      }}
      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-[#0A0E1A]">
        ...
        <div className="absolute top-2 left-2 flex flex-wrap gap-1">
          ...
          <div className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-xs font-bold px-2 py-1 rounded-lg shadow-lg">
              NEW
            </div>
          }
          {item.badges?.includes('hot') &&
          <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white text-xs font-bold px-2 py-1 rounded-lg shadow-lg flex items-center gap-1">
              <Flame className="w-3 h-3" />
              HOT
            </div>
          }
          {item.badges?.includes('bestseller') &&
          <div className="bg-gradient-to-r from-yellow-500 to-orange-600 text-black text-xs font-bold px-2 py-1 rounded-lg shadow-lg flex items-center gap-1">
              <Star className="w-3 h-3 fill-black" />
              BESTSELLER
            </div>
          }
          {item.badges?.includes('fast') &&
          <div className="bg-gradient-to-r from-green-500 to-teal-600 text-white text-xs font-bold px-2 py-1 rounded-lg shadow-lg flex items-center gap-1">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex items-center gap-1">
            ...
            <Flame
              key={i}
              className={`w-3 h-3 ${i < item.spiceLevel! ? 'text-red-500 fill-red-500' : 'text-gray-600'}`} />
        ...
        <div className="flex items-center justify-between">
          ...
          <motion.button
            className="w-10 h-10 bg-gradient-to-br from-cyan-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg shadow-cyan-500/30"
