...
export function FastFoodHeader({ onMenuClick }: FastFoodHeaderProps) {
  ...
  return (
    <motion.header
      className="sticky top-0 z-50 bg-gradient-to-b from-[#0A0E1A] via-[#0F1520] to-transparent backdrop-blur-xl border-b border-cyan-500/20"
      initial={{
        y: -20,
        opacity: 0
      }}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <motion.div
                className="flex items-center gap-1 bg-gradient-to-br from-orange-500 to-red-600 px-2 py-1 rounded-lg shadow-[0_0_12px_rgba(255,107,0,0.4)]"
                initial={{
                  x: -10,
                  opacity: 0
                }}
