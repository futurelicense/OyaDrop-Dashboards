      ...
      <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
        {categories.map((category, index) => {
          ...
          return (
            <motion.button
              key={category.id}
              className={`relative flex-shrink-0 px-4 py-3 rounded-xl transition-all ${isActive ? 'bg-gradient-to-br from-white/10 to-white/5 border-2' : 'bg-[#131B2E] border border-white/10'}`}
              style={{
