  ...
  return (
    <AnimatePresence>
      ...
      <>
          ...
          {/* Drawer */}
          <motion.div
          className="fixed top-0 right-0 bottom-0 w-full max-w-md bg-[#0a1a1f] z-[70] shadow-2xl flex flex-col"
          initial={{
            x: '100%'
          }}
          animate={{
          ...
          transition={{
            ...
            <div className="space-y-4">
              ...
              <motion.div
                key={item.id}
                className="bg-[#1a2a2f] rounded-xl p-4 border border-white/10"
                layout
                initial={{
                  opacity: 0,
                  x: 20
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              <motion.button
                          className="w-7 h-7 bg-[#0f1f24] rounded-lg flex items-center justify-center"
                          onClick={() =>
                          ...
                          whileTap={{
                            scale: 0.9
                              ...
                              <motion.button
                          className="w-7 h-7 bg-[#00ffcc]/20 rounded-lg flex items-center justify-center"
                          onClick={() =>
                          onUpdateQuantity(item.id, item.quantity + 1)
                          }
                          whileTap={{
          ...
          <div className="border-t border-white/10 p-5">
                ...
                <motion.button
              className="w-full bg-gradient-to-r from-[#00ffcc] to-[#00d9ff] text-black font-bold py-4 rounded-xl shadow-lg"
              whileTap={{
                scale: 0.98
              }}>
