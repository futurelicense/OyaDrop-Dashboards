...
export function MarketplaceHeader({
  ...
  return (
    <motion.header
      className="sticky top-0 z-50 bg-[#0a1a1f]/95 backdrop-blur-xl border-b border-[#00ffcc]/20"
      initial={{
        y: -20,
        opacity: 0
      }}
      ...
      <div className="px-5 py-4">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <motion.button
              ...
              {cartItemCount > 0 &&
              <motion.span
                className="absolute -top-1 -right-1 w-5 h-5 bg-[#00ffcc] text-black text-xs font-bold rounded-full flex items-center justify-center"
                initial={{
                  scale: 0
                }}
                animate={{
            ...
            <motion.button
              className="w-9 h-9 rounded-full bg-gradient-to-br from-[#00ffcc] to-[#00d9ff] flex items-center justify-center"
              whileTap={{
                scale: 0.95
              }}>
        ...
        {/* Search Bar */}
        <motion.div
          className={`relative transition-all duration-300 ${searchFocused ? 'ring-2 ring-[#00ffcc]' : ''}`}
          initial={{
            opacity: 0,
            y: 10
          }}
