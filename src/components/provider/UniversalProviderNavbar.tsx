    ...
    <motion.nav
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {/* Earnings */}
          <motion.button
            className="flex items-center gap-1.5 px-3 py-2 bg-green-500/20 border border-green-500/30 rounded-xl"
            whileTap={{
              scale: 0.95
            }}>
          ...
          {/* Online Toggle */}
          <motion.button
            className={`p-2 rounded-xl transition-colors ${isOnline ? 'bg-green-500/20 text-green-400' : 'bg-gray-500/20 text-gray-400'}`}
