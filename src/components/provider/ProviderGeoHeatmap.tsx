...
export function ProviderGeoHeatmap({ providerType }: ProviderGeoHeatmapProps) {
  ...
  return (
    <div className="px-4 py-6">
      ...
      {/* Map Container */}
      <motion.div
        className="relative h-80 bg-gradient-to-br from-[#131B2E] to-[#0F1520] rounded-3xl overflow-hidden border border-cyan-500/20"
        initial={{
          opacity: 0,
          scale: 0.95
        }}
        ...
        {hotspots.map((hotspot, index) => {
          ...
          return (
            <motion.div
              ...
              {/* Hotspot Marker */}
              <motion.div
                className="relative w-12 h-12 rounded-full flex flex-col items-center justify-center cursor-pointer"
                style={{
                  backgroundColor: colors.bg,
              ...
              {/* Tooltip */}
              <motion.div
                className="absolute -top-10 left-1/2 -translate-x-1/2 bg-black/90 backdrop-blur-sm px-3 py-1.5 rounded-lg whitespace-nowrap"
                initial={{
                  opacity: 0,
                  y: 5
                }}
        ...
        <div className="absolute bottom-4 right-4 flex flex-col gap-2">
          <motion.button
            className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/20 hover:bg-white/20 transition-colors"
            whileTap={{
              scale: 0.9
            }}>
      ...
      <div className="grid grid-cols-2 gap-3 mt-4">
        <motion.button
          className="flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-cyan-500 to-teal-500 rounded-xl font-bold text-white shadow-lg shadow-cyan-500/30"
          whileHover={{
            scale: 1.02
          }}
          whileTap={{
        ...
        <motion.button
          className="flex items-center justify-center gap-2 py-3 bg-[#131B2E] border border-white/10 rounded-xl font-bold text-white"
          whileHover={{
            scale: 1.02
          }}
          whileTap={{
