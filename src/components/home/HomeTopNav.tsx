...
export function HomeTopNav({ onMenuClick }: HomeTopNavProps) {
  return (
    <motion.nav
      className="sticky top-0 z-50 bg-black/95 backdrop-blur-xl border-b border-gray-800"
      initial={{
        y: -20,
        opacity: 0
      }}
      ...
      <div className="flex items-center justify-between px-5 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.button
            className="w-9 h-9 rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center"
            whileTap={{
              scale: 0.95
            }}>
