  ...
  return <AnimatePresence>
      {isOpen && <>
        ...
        opacity: 0
          ...
          {/* Sheet */}
          <motion.div className="fixed inset-x-0 bottom-0 z-[90] bg-gradient-to-b from-[#131B2E] to-[#0A0E1A] rounded-t-3xl max-h-[70vh] flex flex-col" initial={{
        y: '100%'
      }} animate={{
        y: 0
      }} exit={{
        ...
        stiffness: 300
            ...
            <div className="flex-1 overflow-y-auto px-6 py-8 flex flex-col items-center justify-center text-center">
              <motion.div className="w-20 h-20 rounded-full flex items-center justify-center mb-6" style={{
