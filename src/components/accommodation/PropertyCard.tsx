...
export function PropertyCard({ property, index = 0 }: PropertyCardProps) {
  ...
  return (
    <motion.div
      className="bg-gradient-to-br from-[#131B2E] to-[#0F1520] rounded-3xl overflow-hidden border border-white/10"
      initial={{
        opacity: 0,
        y: 20
      }}
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {/* Type Badge */}
        <div
          className="absolute top-3 left-3 px-3 py-1.5 rounded-xl font-bold text-xs backdrop-blur-sm"
          style={{
        ...
        {/* Favorite Button */}
        <motion.button
          className="absolute top-3 right-3 w-10 h-10 bg-black/40 backdrop-blur-sm rounded-full flex items-center justify-center"
