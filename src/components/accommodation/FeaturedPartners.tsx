...
export function FeaturedPartners({ onPartnerSelect }: FeaturedPartnersProps) {
  return (
    <div className="px-4 py-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <motion.button
          key={partner.id}
          className="bg-gradient-to-br from-[#131B2E] to-[#0F1520] rounded-2xl p-4 border border-white/10 relative overflow-hidden text-left"
          initial={{
            opacity: 0,
            y: 20
          }}
          ...
          <div className="absolute top-2 right-2">
                <motion.div
              className="bg-gradient-to-r from-yellow-400 to-orange-500 p-1.5 rounded-lg shadow-lg"
              animate={{
                rotate: [0, -5, 5, 0]
              }}
              transition={{
            ...
            <div className="text-center mb-3">
              <div className="flex items-center justify-center gap-1 mb-1">
                ...
                {partner.verified &&
              <CheckCircle className="w-3.5 h-3.5 text-cyan-400 fill-cyan-400 flex-shrink-0" />
              }
              </div>
