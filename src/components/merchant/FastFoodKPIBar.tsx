      ...
      <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
        {displayedKpis.map((kpi, index) => {
          ...
          return (
            <motion.div
              key={kpi.label}
              className="flex-shrink-0 w-32 bg-gradient-to-br from-[#131B2E] to-[#0F1520] rounded-2xl p-4 border border-white/10 relative overflow-hidden"
              initial={{
                opacity: 0,
                y: 20
              }}
        ...
        {!showAll &&
        <motion.button
          className="flex-shrink-0 w-32 bg-gradient-to-br from-cyan-500/10 to-teal-500/10 rounded-2xl p-4 border-2 border-dashed border-cyan-500/30 hover:border-cyan-500/50 transition-colors flex flex-col items-center justify-center gap-2"
        ...
        {showAll &&
        <motion.button
          className="flex-shrink-0 w-32 bg-gradient-to-br from-gray-500/10 to-gray-600/10 rounded-2xl p-4 border-2 border-dashed border-gray-500/30 hover:border-gray-500/50 transition-colors flex flex-col items-center justify-center gap-2"
