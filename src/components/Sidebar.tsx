  ...
  return (
    <AnimatePresence>
      ...
      <>
          ...
          {/* Sidebar */}
          <motion.div
          className={`fixed top-0 left-0 bottom-0 w-72 border-r z-[70] shadow-2xl overflow-y-auto ${isProviderView ? 'bg-gradient-to-b from-[#1a3a3a] via-[#1f4545] to-[#1a3a3a] border-teal-500/20' : 'bg-gradient-to-b from-[#0a1a1f] via-[#0f2027] to-[#0a1a1f] border-white/10'}`}
          initial={{
            x: '-100%'
          }}
          animate={{
          ...
          <>
                ...
                <nav className="p-4 space-y-1.5">
                  {/* Dashboard */}
                  <motion.button
                className="w-full text-left px-4 py-3 rounded-xl bg-teal-500/20 border border-teal-500/30 text-white font-semibold text-sm hover:bg-teal-500/30 transition-all"
                initial={{
                  opacity: 0,
                  y: -10
                }}
                ...
                whileTap={{
                  ...
                  <div>
                    <motion.button
                  className="w-full flex items-center justify-between px-4 py-3 rounded-xl hover:bg-white/5 text-white font-semibold text-sm transition-all"
                  ...
                  <motion.div
                    className="ml-3 mt-1.5 space-y-1.5 border-l-2 border-teal-500/20 pl-3"
                    initial={{
                      opacity: 0,
                      height: 0
                    }}
                      ...
                      duration: 0.2
                        ...
                        onClick={() => toggleSection('marketplaceOrders')}>
                          ...
                          className={`w-3.5 h-3.5 text-gray-400 transition-transform ${expandedSections.marketplaceOrders ? 'rotate-180' : ''}`} />
                            ...
                            <AnimatePresence>
                              {expandedSections.marketplaceOrders &&
                        <motion.div
                          className="ml-3 mt-1 space-y-1"
                          initial={{
                            opacity: 0,
                  ...
                  {/* Vehicle Management */}
                  <motion.button
                className="w-full text-left px-4 py-3 rounded-xl hover:bg-white/5 text-white font-semibold text-sm transition-all"
                initial={{
                  opacity: 0,
                  y: -10
                }}
                ...
                whileTap={{
                  ...
                  {/* Live Location */}
                  <motion.button
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-white font-semibold text-sm transition-all"
                initial={{
                  opacity: 0,
                  y: -10
                }}
                ...
                <div className="p-4 border-t border-teal-500/20 mt-auto">
                  <motion.button
                className="w-full py-3 bg-gradient-to-r from-teal-500 to-green-500 rounded-xl text-white font-bold flex items-center justify-center gap-2 hover:from-teal-600 hover:to-green-600 transition-all shadow-lg shadow-teal-500/20"
                initial={{
                  opacity: 0,
                  y: 20
                }}
          ...
          <>
                ...
                <div className="flex items-center justify-between p-5 border-b border-white/10">
                  <motion.div
                className="text-xl font-bold bg-gradient-to-r from-[#00ffcc] to-[#00d9ff] bg-clip-text text-transparent"
                initial={{
                  opacity: 0,
                  x: -20
                }}
                ...
                transition={{
                  ...
                  return (
                    <motion.button
                      key={item.id}
                      className={`w-full flex items-center gap-4 px-4 py-3.5 rounded-xl transition-all ${isActive ? 'bg-gradient-to-r from-[#00ffcc]/20 to-[#00d9ff]/10 border border-[#00ffcc]/30' : 'hover:bg-white/5 border border-transparent'}`}
                ...
                <div className="p-4 border-t border-white/10 mt-auto">
                  <motion.button
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition-all"
                initial={{
                  opacity: 0,
                  y: 20
                }}
