            ...
            return (
              <motion.div
                ...
                <div className="relative aspect-square">
                  ...
                  <div
                    className="absolute top-2 left-2 text-[10px] font-bold px-2 py-1 rounded-lg border"
                    style={{
                ...
                <div className="p-3">
                  ...
                  <div className="flex gap-2">
                    <motion.button
                      className={`flex-1 py-2 rounded-lg text-xs font-semibold transition-colors ${med.available ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'bg-gray-600/20 text-gray-400 border border-gray-600/30'}`}
                      whileTap={{
                        scale: 0.95
                      }}
