...
export function UploadStockSheet({ isOpen, onClose }: UploadStockSheetProps) {
          ...
          transition={{
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <motion.button
                  className={`p-4 rounded-xl border-2 transition-all ${uploadMethod === 'bulk' ? 'bg-yellow-500/20 border-yellow-500 text-yellow-400' : 'bg-[#0A0E1A] border-white/10 text-gray-400'}`}
                  ...
                  <motion.button
                  className={`p-4 rounded-xl border-2 transition-all ${uploadMethod === 'manual' ? 'bg-yellow-500/20 border-yellow-500 text-yellow-400' : 'bg-[#0A0E1A] border-white/10 text-gray-400'}`}
            ...
            <>
                  ...
                  <div>
                    ...
                    <motion.button
                  className="w-full p-12 bg-[#0A0E1A] border-2 border-dashed border-white/10 rounded-xl hover:border-yellow-500/50 transition-colors"
                  whileTap={{
                    scale: 0.98
                  }}>
                  ...
                  <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4">
                    ...
                    <motion.button
                  className="w-full py-2.5 bg-yellow-500/20 border border-yellow-500/30 rounded-xl text-yellow-400 font-semibold text-sm"
                  whileTap={{
                    scale: 0.98
                  }}>
                ...
                'Include: Brand Name, Generic Name, Form, Strength, Price, Stock, Expiry',
                'Classification: OTC, Prescription, or Controlled'].
                map((req, index) =>
            ...
            <div className="px-6 py-4 border-t border-white/10 bg-[#0A0E1A]">
              <motion.button
              className="w-full bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-bold py-4 rounded-xl shadow-lg flex items-center justify-center gap-2"
              whileTap={{
                scale: 0.98
              }}>
