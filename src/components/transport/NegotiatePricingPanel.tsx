...
export function NegotiatePricingPanel() {
  return (
    <div className="px-4 py-4">
      <motion.div
        className="bg-gradient-to-br from-[#131B2E] to-[#0F1520] rounded-2xl p-5 border border-purple-500/30"
        initial={{
          opacity: 0,
          y: 20
        }}
        ...
        {/* Send Offer Button */}
        <motion.button
          className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-4 rounded-xl shadow-lg shadow-purple-500/30"
          whileHover={{
            scale: 1.02
          }}
          whileTap={{
