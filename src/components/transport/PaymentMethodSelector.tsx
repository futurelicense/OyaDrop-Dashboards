      ...
      <div className="grid grid-cols-2 gap-3">
        {paymentMethods.map((method, index) => {
          ...
          return (
            <motion.button
              key={method.id}
              className={`bg-gradient-to-br from-[#131B2E] to-[#0F1520] rounded-2xl p-4 border-2 transition-all ${isSelected ? 'border-cyan-500 shadow-lg shadow-cyan-500/30' : 'border-white/10'}`}
