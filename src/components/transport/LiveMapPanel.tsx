      ...
      <div className="relative h-80 bg-gradient-to-br from-[#131B2E] to-[#0F1520] rounded-3xl overflow-hidden border border-cyan-500/20">
        ...
        <motion.div
          ...
          transition={{
            ...
            {/* Driver Icon */}
            <motion.div
            className="relative w-8 h-8 bg-white rounded-full flex items-center justify-center text-lg shadow-lg cursor-pointer"
            whileHover={{
              scale: 1.2
            }}
            whileTap={{
        ...
        {/* Pickup Pin (Example) */}
        <motion.div
          className="absolute top-[25%] left-[40%] z-15"
          initial={{
            y: -20,
            opacity: 0
          }}
        ...
        <motion.div
          className="absolute top-[70%] left-[65%] z-15"
          initial={{
            y: -20,
            opacity: 0
          }}
