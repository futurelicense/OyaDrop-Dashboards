  ...
  return (
    <motion.nav
      ...
      <div className="flex items-center justify-between px-5 py-4">
        ...
        <motion.div
          className="text-xl font-bold bg-gradient-to-r from-[#00d9ff] to-[#00ffcc] bg-clip-text text-transparent"
          initial={{
            scale: 0.9,
            opacity: 0
          }}
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.button
            className="w-9 h-9 rounded-full bg-gradient-to-br from-[#00d9ff] to-[#00ffcc] p-0.5 shadow-[0_0_12px_rgba(0,217,255,0.3)]"
            whileTap={{
              scale: 0.95
            }}>
