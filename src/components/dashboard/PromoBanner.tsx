    ...
    <motion.div
      ...
      <div className="bg-gradient-to-br from-[#1a1a24] via-[#1f1f2e] to-[#1a1a24] rounded-2xl p-6 border border-white/10 shadow-2xl overflow-hidden relative">
        ...
        <div className="relative">
          ...
          <motion.button
            className="bg-gradient-to-r from-[#00d9ff] to-[#00ffcc] rounded-full py-3 px-6 font-semibold text-[#0a0a0f] flex items-center gap-2 shadow-[0_0_20px_rgba(0,217,255,0.3)]"
            whileHover={{
              scale: 1.05,
