      ...
      <div className="grid grid-cols-2 gap-3">
        {tiles.map((tile, index) => {
          ...
          return (
            <motion.button
              key={tile.label}
              className="relative bg-gradient-to-br from-[#1a1a24]/80 to-[#1f1f2e]/80 backdrop-blur-xl rounded-2xl p-5 border border-white/10 text-left overflow-hidden group"
              initial={{
                opacity: 0,
                y: 20
              }}
