...
export function WalletStreak() {
  ...
  return (
    <div className="px-4 py-6">
      <motion.div
        className="relative rounded-3xl bg-gradient-to-br from-orange-900/20 via-red-900/20 to-orange-800/20 border border-orange-500/30 overflow-hidden p-6"
        initial={{
          opacity: 0,
          scale: 0.95
        }}
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <motion.div
                className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-400 to-red-600 flex items-center justify-center shadow-[0_0_24px_rgba(255,107,0,0.5)]"
                animate={{
                  scale: [1, 1.1, 1]
                }}
                transition={{
          ...
          <div className="space-y-3">
            ...
            <motion.div
              key={milestone.day}
              className={`flex items-center justify-between p-3 rounded-xl ${milestone.unlocked ? 'bg-green-500/10 border border-green-500/30' : 'bg-white/5 border border-white/10'}`}
              initial={{
                opacity: 0,
                x: -20
              }}
              ...
              transition={{
                ...
                {milestone.day === 7 && milestone.unlocked &&
              <motion.div
                animate={{
                  rotate: [0, 10, -10, 0]
                }}
