...
function ServiceTile({ icon, label, delay }: ServiceTileProps) {
  return (
    <motion.button
      initial={{
        opacity: 0,
      ...
      className="relative p-6 rounded-3xl bg-gradient-to-br from-[#132337] to-[#0F1D2E] border border-white/5 hover:border-teal-500/30 transition-all group"
      style={{
        boxShadow:
