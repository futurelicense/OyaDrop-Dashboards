...
export function OyaCoinVault() {
  ...
  return (
    <div className="px-4 mb-6">
      <motion.div
        className="relative rounded-3xl bg-gradient-to-br from-amber-900/20 via-yellow-900/20 to-amber-800/20 border border-amber-500/30 overflow-hidden"
        initial={{
          opacity: 0,
          scale: 0.95
        }}
        ...
        <motion.button
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <motion.div
                className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-400 to-yellow-600 flex items-center justify-center shadow-[0_0_24px_rgba(255,215,0,0.4)]"
                animate={{
              ...
              <motion.div
                ...
                transition={{
                  delay: 0.2
                    ...
                    <motion.button
                  className="w-full bg-gradient-to-r from-yellow-500 to-amber-500 px-4 py-2.5 rounded-xl font-bold text-black text-sm shadow-lg flex items-center justify-center gap-2"
                  whileHover={{
                    scale: 1.02
                  }}
                  whileTap={{
                ...
                transition={{
                  delay: 0.2
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <motion.button
                    className="bg-gradient-to-r from-purple-500 to-pink-500 px-4 py-2 rounded-xl font-bold text-white text-sm shadow-lg"
                    whileHover={{
                      scale: 1.05
                    }}
                    whileTap={{
