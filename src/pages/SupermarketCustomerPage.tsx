    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0A0E1A] via-[#0F1520] to-[#0A0E1A]">
      ...
      <div className="sticky top-0 z-40 bg-[#0A0E1A]/95 backdrop-blur-lg border-b border-white/10">
        <div className="flex items-center justify-between p-4">
          ...
          <motion.button
            className="relative p-3 rounded-xl bg-green-500/20 border border-green-500/30"
            ...
            {cartItemCount > 0 &&
            <motion.span
              className="absolute -top-1 -right-1 w-5 h-5 bg-green-500 rounded-full text-white text-xs font-bold flex items-center justify-center"
              initial={{
                scale: 0
              }}
              animate={{
        ...
        <div className="px-4 pb-4 overflow-x-auto scrollbar-hide">
          <div className="flex gap-2">
            ...
            <motion.button
              key={category}
              className={`flex-shrink-0 px-4 py-2 rounded-xl font-semibold text-sm transition-all ${selectedCategory === category ? 'bg-green-500 text-white' : 'bg-[#131B2E] text-gray-400 border border-white/10'}`}
        ...
        <div className="space-y-3">
          {mockVendors.map((vendor, index) => {
            ...
            return (
              <motion.button
                key={vendor.id}
                className={`w-full bg-gradient-to-br from-[#131B2E] to-[#0F1520] rounded-2xl p-4 border-2 transition-all text-left ${isSelected ? 'border-green-500 bg-green-500/10' : 'border-white/10'}`}
                initial={{
                  opacity: 0,
                  x: -20
                }}
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold text-white">
            {selectedVendor ?
            `${mockVendors.find((v) => v.id === selectedVendor)?.name} Products` :
            'All Products'}
          </h2>
            ...
            return (
              <motion.div
                ...
                <div className="p-3">
                  ...
                  {/* Add to Cart */}
                  <motion.button
                    className="w-full py-2 bg-green-500 rounded-xl text-white font-semibold text-sm disabled:opacity-50 flex items-center justify-center gap-2"
      ...
      <AnimatePresence>
        ...
        <>
            ...
            <div className="px-6 py-4 border-t border-white/10 bg-[#0A0E1A] space-y-3">
                  ...
                  <motion.button
                className="w-full py-4 bg-gradient-to-r from-green-500 to-teal-500 rounded-xl text-white font-bold shadow-lg"
                onClick={() => {
                  setShowCart(false);
            ...
            transition={{
              ...
              <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
                ...
                <div>
                  ...
                  <motion.button
                    key={option.value}
                    className={`p-3 rounded-xl border-2 transition-all ${deliveryTime === option.value ? 'bg-green-500/20 border-green-500' : 'bg-[#0A0E1A] border-white/10'}`}
              ...
              <div className="px-6 py-4 border-t border-white/10 bg-[#0A0E1A]">
                <motion.button
                className="w-full py-4 bg-gradient-to-r from-green-500 to-teal-500 rounded-xl text-white font-bold shadow-lg flex items-center justify-center gap-2"
                whileTap={{
                  scale: 0.98
                }}
        ...
        <>
            ...
            transition={{
              ...
              <div className="flex-1 overflow-y-auto px-6 py-8 flex flex-col items-center justify-center text-center">
                ...
                <motion.p
                className="text-gray-400 mb-2 max-w-sm"
                initial={{
                  opacity: 0,
                  y: 10
                }}
                ...
                <motion.div
                className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 mb-8 w-full max-w-sm"
                initial={{
                  opacity: 0,
                  y: 10
                }}
