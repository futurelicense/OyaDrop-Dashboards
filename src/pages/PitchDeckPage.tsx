...
export function PitchDeckPage({ onBack }: PitchDeckPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0A0E1A] via-[#0F1520] to-[#0A0E1A] flex flex-col overflow-hidden">
      {/* Slide Content */}
        ...
        <AnimatePresence initial={false} custom={direction} mode="wait">
          <motion.div
                  ...
                  <AppMockup type="desktop" delay={0.3}>
                    <div className="bg-gradient-to-br from-[#0a1a1f] to-[#0f2027] min-h-full p-4">
                      ...
                      <div className="bg-white/5 border border-white/10 rounded-lg p-3 mb-3">
                        ...
                        <div
                          key={i}
                          className="flex-1 bg-gradient-to-t from-cyan-500 to-teal-500 rounded-t"
                          style={{
                            height: `${height}%`
                          }} />
            ...
            <div className="text-center">
                ...
                <motion.h1
                className="text-7xl font-bold mb-4 bg-gradient-to-r from-cyan-400 via-teal-400 to-green-400 bg-clip-text text-transparent"
                initial={{
                  opacity: 0,
                  y: 20
                }}
            ...
            <div>
                ...
                <div className="grid grid-cols-3 gap-6">
                  ...
                  return (
                    <motion.div
                      key={index}
                      className="bg-gradient-to-br from-cyan-500/10 to-teal-500/10 border border-cyan-500/20 rounded-2xl p-6 text-center"
                      initial={{
                        opacity: 0,
                        scale: 0.8
                      }}
            ...
            <div>
                ...
                <motion.div
                  key={index}
                  className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 rounded-xl p-6 flex items-center gap-6"
                  initial={{
                    opacity: 0,
                    x: -20
                  }}
            ...
            <div>
                ...
                <motion.div
                  key={index}
                  className="bg-gradient-to-r from-cyan-500/10 to-teal-500/10 border border-cyan-500/20 rounded-xl p-6 flex items-center gap-6"
                  initial={{
                    opacity: 0,
                    x: -20
                  }}
            ...
            <div>
                ...
                <div className="text-center mb-12">
                  <motion.div
                  className="inline-block px-8 py-4 bg-gradient-to-r from-cyan-500 to-teal-500 rounded-2xl"
                  initial={{
                    scale: 0
                  }}
                  animate={{
                ...
                <motion.div
                  key={index}
                  className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 rounded-xl p-4 flex items-center gap-4"
                  initial={{
                    opacity: 0,
                    x: -20
                  }}
            ...
            <div className="text-center">
                ...
                <p className="text-2xl text-cyan-400 mb-8">{slide.subtitle}</p>
                <motion.div
                className="max-w-2xl mx-auto bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-2xl p-12"
                initial={{
                  opacity: 0,
                  scale: 0.9
                }}
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`h-2 rounded-full transition-all ${index === currentSlide ? 'w-8 bg-cyan-500' : 'w-2 bg-white/20 hover:bg-white/40'}`} />
