...
},
{
  ...
  price: 800,
  image:
  'https://images.unsplash.com/photo-1550572017-4a6e8d8a1b88?w=400&h=400&fit=crop',
  rating: 4.7,
  inStock: true,
  requiresPrescription: false,
  category: 'Vitamins'
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0A0E1A] via-[#0F1520] to-[#0A0E1A]">
      ...
      <div className="sticky top-0 z-40 bg-[#0A0E1A]/95 backdrop-blur-lg border-b border-white/10">
        <div className="flex items-center justify-between p-4">
          ...
          <motion.button
            className="relative p-3 rounded-xl bg-purple-500/20 border border-purple-500/30"
            ...
            {cartItemCount > 0 &&
            <motion.span
              className="absolute -top-1 -right-1 w-5 h-5 bg-purple-500 rounded-full text-white text-xs font-bold flex items-center justify-center"
              initial={{
                scale: 0
              }}
              animate={{
        ...
        <div className="px-4 pb-4 overflow-x-auto scrollbar-hide">
          <div className="flex gap-2">
            ...
            <motion.button
              key={category}
              className={`flex-shrink-0 px-4 py-2 rounded-xl font-semibold text-sm transition-all ${selectedCategory === category ? 'bg-purple-500 text-white' : 'bg-[#131B2E] text-gray-400 border border-white/10'}`}
      ...
      {hasPrescriptionItems && !showPrescriptionUpload &&
      <motion.div
        className="mx-4 mt-4 bg-purple-500/10 border border-purple-500/30 rounded-xl p-4"
        initial={{
          opacity: 0,
          y: -10
        }}
          ...
          transition={{
            ...
            <div className="p-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <motion.button
                className="p-2 bg-purple-500 rounded-xl disabled:opacity-50"
      ...
      <AnimatePresence>
        ...
        <>
            ...
            <div className="px-6 py-4 border-t border-white/10 bg-[#0A0E1A] space-y-3">
                  ...
                  <motion.button
                className="w-full py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-white font-bold shadow-lg"
                onClick={() => {
                  setShowCart(false);
        ...
        <>
            ...
            transition={{
              ...
              <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {['ASAP (30 min)', 'Schedule Later'].map((option) =>
                  <motion.button
                    key={option}
                    className="p-3 rounded-xl border-2 border-purple-500/30 bg-purple-500/10 text-white font-semibold"
                    whileTap={{
                      scale: 0.98
                    }}>
              ...
              <div className="px-6 py-4 border-t border-white/10 bg-[#0A0E1A]">
                <motion.button
                className="w-full py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-white font-bold shadow-lg flex items-center justify-center gap-2"
                whileTap={{
                  scale: 0.98
                }}
                onClick={() => {
