...
export function SidebarPage({ onNavigate }: SidebarPageProps) {
  ...
  return (
    <div className="min-h-screen bg-black flex overflow-hidden relative">
      ...
      <motion.button
        className="fixed top-6 left-6 z-[100] w-14 h-14 bg-gradient-to-br from-cyan-500 to-teal-500 rounded-2xl flex items-center justify-center shadow-2xl"
      ...
      <AnimatePresence>
        {sidebarOpen &&
        <motion.div
          className="fixed left-0 top-0 bottom-0 w-96 z-[70] flex items-center justify-center"
          initial={{
            x: -400
          }}
          animate={{
          ...
          transition={{
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              {/* Center OyaDrop Logo */}
              <motion.div
              className="absolute w-24 h-24 rounded-full bg-gradient-to-br from-cyan-500 to-teal-500 flex items-center justify-center z-10"
              initial={{
                scale: 0,
                opacity: 0
              }}
          ...
          <motion.div
            ...
            <div className="relative bg-gradient-to-br from-[#0A0E1A] to-[#0F1520] rounded-2xl p-6 border border-cyan-500/20 backdrop-blur-xl">
              ...
              <div className="space-y-3">
                ...
                <motion.div
                  key={activity.id}
                  className="flex items-center gap-4 p-4 bg-black/40 rounded-xl border border-white/5 hover:border-cyan-500/30 transition-all group"
                  initial={{
                    opacity: 0,
                    x: -20
                  }}
                  ...
                  transition={{
                    ...
                    whileHover={{
                      ...
                      animate={{
                        boxShadow: [
                        `0 0 0px ${activity.color}`,
                        `0 0 15px ${activity.color}`,
                        `0 0 0px ${activity.color}`]
